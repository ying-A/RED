...
class HredAgent(TorchGeneratorAgent):
    ...
    def add_cmdline_args(cls, argparser):
        ...
        agent.add_argument('-hier_hs', '--hier_hiddensize', type=int, default=128,
                           help='size of the hier_rnn hidden layers')
        ...
        agent.add_argument('-hier_nl', '--hier_numlayers', type=int, default=2,
                           help='number of hidden layers')     
        ...
        agent.add_argument('-bi', '--bidirectional', type='bool',
                           ...
                           help='whether to encode the context with a '
                                'bidirectional rnn')
        agent.add_argument('-hier_bi', '--hier_bidirectional', type='bool',
                           default=False,
                           help='whether to encode the context with a '
                                'bidirectional rnn')
        ...
        agent.add_argument('--attention-time', default='post',
                           ...
                           help='Whether to apply attention before or after '
                                'decoding.')
        agent.add_argument('-rnn', '--rnn_class', default='gru',
    ...
    def build_model(self, states=None):
        ...
        self.model = Hred(
            opt['order'],len(self.dict), opt['embeddingsize'], opt['hiddensize'],opt['hier_hiddensize'],
            padding_idx=self.NULL_IDX, start_idx=self.START_IDX,
            end_idx=self.END_IDX, unknown_idx=self.dict[self.dict.unk_token],
            longest_label=states.get('longest_label', 1),**kwargs)
    ...
    def vectorize(self, *args, **kwargs):
        """Override vectorize for hred."""
        kwargs['add_start'] = False  # model does this in module code
        kwargs['add_end'] = True  # we do want this
        return super().vectorize(*args, **kwargs)

    def batchify(self, *args, **kwargs):
        """Override batchify options for hred."""
